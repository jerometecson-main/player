...
export default function DynamicTip() {
  ...
  return (
    <div
      className={`absolute lg:bottom-4 md:bottom-2 bottom-1 max-[340px]:bottom-0 left-1/2 -translate-x-1/2 z-10 text-center max-[340px]:text-[0.5rem] text-xs  md:text-base lg:text-lg transition-opacity duration-500 w-full p-4 max-[340px]:p-0.5 ${
